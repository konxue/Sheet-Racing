...
EnemyVehicle = Vehicle:new({HP = 100, Speed = 0, TopSpeed = 95, Value = 50, TurnRatio = 3, Enemies = {}})
...
function EnemyVehicle:Start()
    transition.to(self, {time = 7000, Speed = self.TopSpeed, transition = easing.inCirc})
    local num = 0
